package com.free.grfastmvvm.rxhttp.http.basehttp;
...
import com.free.grfastmvvm.rxhttp.DaoFilePahtUtils;
import com.free.grfastmvvm.rxhttp.http.cookie.PersistentCookieStore;
import com.free.grfastmvvm.rxhttp.http.progress.ProgressResponseBody;
...
//                    .cache(cache)//以后如果使用缓存机制，很久更新一次的再打开并使用Get进行
    ...
    private static Interceptor baseInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!isNetworkReachable(UtilsInstance.getContext())) {
                /**
...
//                        "服务器返回数据" + buffer.clone().readString(Charset.forName("UTF-8")));
    ...
    private static class CookiesManager implements CookieJar {
        private final PersistentCookieStore cookieStore = new PersistentCookieStore(UtilsInstance.getContext());
